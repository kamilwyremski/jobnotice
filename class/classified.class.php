		...
		if ($send_mail) {
			if ($user->getId()) {
				...
				mail::send('classified_start_not_logged', $data['email'], [
					'classified_edit_link' => absolutePath('edit', $id, $classified['slug']) . '?code=' . $code,
					'classified_activate_link' => absolutePath('classified', $id, $classified['slug']) . '?activate&code=' . $code,
